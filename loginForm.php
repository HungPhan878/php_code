...
<body>
    <h1 class="container mt-2 mb-2">Login</h1>

    <form action="loginFunction.php" method="post" class="container mt-5">
        <div class="row mb-3">
        ...
        <div class="row">
            <div class="col-md-10 offset-md-2">
                <input type="submit" name="loginFunc" value="Login" class="btn btn-primary">
            </div>
        </div>
    </form>
